package scala.com.atguigu.spark.core.rdd.operator.transforn.doublevalue
...
/**
 * @Author Ding Han
 * @Description Spark - RDD - 算子（方法） - 并/交/差/拉链
 * @create 2020-06-05 18:30
 * @Version 1.0
 */
object DoubleValue01 {
    def main(args: Array[String]): Unit = {
        // TODO Spark - RDD - 算子（方法） - 并/交/差/拉链
        ...
        // TODO 并集 - union, 数据合并，分区也会合并（即A + B）
        val rdd3: RDD[Int] = rdd1.union(rdd2)
        //println(rdd3.collect().mkString(","))
        //rdd3.saveAsTextFile("output3")

        // TODO 交集 - intersection ： 保留最大分区数 ，数据被打乱重组, shuffle
        val rdd4: RDD[Int] = rdd1.intersection(rdd2)
        //println(rdd4.collect().mkString(","))
        //rdd4.saveAsTextFile("output4")

        // TODO 差集 - subtract: 数据被打乱重组, shuffle
